...
from models.NovelHTI_ablation_without_pathways import MainModel as Model
...
from utils.logging import set_log, change_log_file

import pandas as pd
import json
import logging

with open('../configs/NovelHTI_ablation_without_pathways.json', 'r', encoding='utf-8') as f:
    config = json.load(f)

log_step = True

for data_setting in ['01', '03', '05']:

    data_setting_dict = {
        '01': 'exp_dataset_0.250_0.200_min_2_select_2_Pv',
        '02': 'exp_dataset_0.250_0.200_min_2_select_min_Pv',
        '03': 'exp_dataset_0.550_0.175_min_5_select_5_Pv',
        '04': 'exp_dataset_0.550_0.175_min_5_select_min_Pv',
        '05': 'exp_dataset_0.550_0.175_min_20_select_20_Pv',
        '06': 'exp_dataset_0.550_0.175_min_20_select_min_Pv'
    }
    ...
    if log_step:
        ...
        folder_path = config['train']['log_folder'] + data_setting
        if not os.path.exists(folder_path):
            os.mkdir(folder_path)

        set_log(folder_path + '/' + config['train']['model_name'] + '.log')
        ...
        change_log_file(folder_path + '/' + config['train']['model_name'] + '.log')
    ...
    for seed in [10, 20, 30]:
        ...
        for val, test in [[0,1], [1,2], [2,3], [3,4], [4,0]]:

            df = pd.read_csv(f"../{data_setting_dict[data_setting]}/seed={seed}.csv")
